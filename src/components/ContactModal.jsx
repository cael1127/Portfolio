...
const ContactModal = ({ isOpen, onClose }) => {
  ...
  const handleDirectContact = (type) => {
    switch (type) {
      case 'email':
        window.open('mailto:findleytechs@gmail.com?subject=Portfolio Contact', '_blank');
        break;
      case 'phone':
        window.open('tel:+13619206493', '_blank');
        break;
      case 'linkedin':
        window.open('https://linkedin.com/in/caelfindley', '_blank');
        break;
      case 'github':
        ...
        <div className="p-6 bg-gray-800 rounded-b-lg">
          ...
          <div className="space-y-2 text-gray-300">
            <div className="flex items-center space-x-2">
              ...
              <span>findleytechs@gmail.com</span>
            </div>
            <div className="flex items-center space-x-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
