      ...
      <div className="bg-gray-800 border-b border-gray-700 p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-white">🤖 RAG Chatbot Demo</h1>
            <p className="text-gray-400 text-sm">Retrieval-Augmented Generation chatbot with context awareness</p>
          </div>
