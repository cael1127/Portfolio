      ...
      <div className="bg-gray-800 border-b border-gray-700 p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-white">😊 Sentiment Analysis Demo</h1>
            <p className="text-gray-400 text-sm">Advanced sentiment analysis with VADER, Transformers, and NLTK</p>
          </div>
